      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h1 
            ...
            style={{ 
              textShadow: '0 2px 8px rgba(0,0,0,0.9), 0 0 3px rgba(0,0,0,0.9), 0 0 15px rgba(0,0,0,0.8)',
          ...
          <div className="bg-navy-dark/50 p-4 md:p-5 rounded-lg shadow-lg mb-5 md:mb-8 border border-gold/30 text-left" style={textStyle}>
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-sm md:text-base" style={textStyle}><strong>교육 대상</strong> : 해군 해상 근무 장병</span>
              </li>
              <li className="flex items-start">
                <span className="bg-white text-navy rounded-full w-5 h-5 flex items-center justify-center mr-2 flex-shrink-0 mt-0.5">
                  <Calendar size={12} className="text-navy" />
                </span>
                <span className="text-sm md:text-base" style={textStyle}><strong>교육 형태</strong> : 합숙형(1박 2일) 또는 집중형(1일)</span>
              </li>
              <li className="flex items-start">
                <span className="bg-white text-navy rounded-full w-5 h-5 flex items-center justify-center mr-2 flex-shrink-0 mt-0.5">
                  <MapPin size={12} className="text-navy" />
                </span>
                <span className="text-sm md:text-base" style={textStyle}><strong>교육 장소</strong> : 함대 소재지 인근 교육시설</span>
              </li>
              <li className="flex items-start">
                <span className="bg-white text-navy rounded-full w-5 h-5 flex items-center justify-center mr-2 flex-shrink-0 mt-0.5">
                  <BookOpen size={12} className="text-navy" />
                </span>
                <span className="text-sm md:text-base" style={textStyle}><strong>교육 내용</strong> : 해군 정체성 교육, 군인정신 함양, 맞춤형 정신전력 프로그램</span>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
            <button
              ...
              style={textStyle}
            >
              <Calendar size={16} className="mr-2 flex-shrink-0" /> 일정표 접속 요청
            </button>
            <a
              href="#application"
              ...
              style={textStyle}
            >
              <Edit size={16} className="mr-2 flex-shrink-0" /> 교육 신청안내
            </a>
          </div>
        </div>
      </div>
